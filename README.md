...
I build AI-powered systems, backend infrastructures, and autonomous agent workflows focused on real-world applications.

- Exploring long-term memory systems and multi-agent orchestration
- Building scalable AI workflows with LangGraph and FastAPI
- Interested in distributed systems, RAG pipelines, and developer tooling
- Focused on backend-heavy engineering with modern AI integration
